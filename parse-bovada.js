  ...
  try {
    ...
    if (response.ok) {
      ...
      for (i=0; i<gamesArray.length; i++) {
        ...
        const awayTeamSpread = gamesArray[i].displayGroups[0].markets[indexOfSpread].outcomes[0];
        const homeTeamSpread = gamesArray[i].displayGroups[0].markets[indexOfSpread].outcomes[1];
